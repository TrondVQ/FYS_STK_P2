...
def GD(X,y,betainit,niterations,eta,lmbda=0,gamma=0):
    """
    Gradient descent with a constant learning rate (eta) and optional momentum (gamma)

    Args:
        X (ndarray): design matrix
        y (ndarray): target values
        betainit (ndarray): inital regression parameteres
        niterations (int): max iterations
...
def GD_Adagrad(X,y,betainit,niterations,eta,delta=1e-7,lmbda=0,gamma=0):
    """
